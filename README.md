...
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=cylinder&height=200&color=0:8200ff,100:00eaff&text=Dara%20⚡&fontColor=ffffff&fontSize=45&animation=scaleIn" />
</p>
...
**Languages**
`C++` `Python` `JS/TS` `Java` `Dart`

**Frontend**
`React` `Vite` `Tailwind`  

**Backend / Cloud**
`Flask` `Node` `AWS` `Socket.IO` `Docker`

**Databases**
`MongoDB` `Postgres`

<p align="center">
  <img src="https://skillicons.dev/icons?i=cpp,py,js,ts,java,react,tailwind,vite,nodejs,aws,mongodb,docker,git,linux&theme=dark" />
</p>
